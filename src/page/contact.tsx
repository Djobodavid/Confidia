  ...
  return (
    <div className="form-container flex-col gap-1.5">
      <form className="contact-form">
        ...
        />
        <InputText value={formData.sujet} 
...
{/* 
  ...
  <BoutonComponent className="mb-1 w-3/4" buttonText="Envoyer" onClick={handleSubmit} />
         <BoutonComponent className="bg-red-500 text-white w-3/4" buttonText="Annuler" onClick={resetForm} />
